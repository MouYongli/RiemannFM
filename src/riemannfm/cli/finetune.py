...
def main(cfg: DictConfig):
    ...
    train_dataset = RiemannFMKGDataset(
        data_dir=cfg.data.data_dir,
        manifold=manifold,
        split="train",
        mode="triple",
    )
    val_dataset = RiemannFMKGDataset(
        data_dir=cfg.data.data_dir,
        manifold=manifold,
        split="valid",
        mode="triple",
    ...
    if pretrained_path:
        from riemannfm.utils.checkpoint import load_checkpoint
    ...
    # ─── Training loop ────────────────────────────────────────────────
    from riemannfm.utils.logging import log_metrics, setup_wandb
