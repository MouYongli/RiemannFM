...
class RiemannFMODEFunc(nn.Module):
...
class RiemannFMODESolver(nn.Module):
    ...
    def _adaptive_solve(
        ...
        ode_func = RiemannFMODEFunc(network_fn, self.manifold, e_t, condition)
        ...
        from riemannfm.manifolds.utils import project_to_lorentz, project_to_sphere
