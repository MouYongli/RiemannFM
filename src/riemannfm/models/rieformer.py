...
The backbone network for RiemannFM. Stacks multiple REDFormerBlocks
...
from riemannfm.models.heads import RiemannFMContinuousVFHead, RiemannFMDiscreteEdgeHead
...
class RiemannFMRieFormer(nn.Module):
    ...
    def __init__(
        ...
        self.time_embed = RiemannFMTimestepEmbedding(time_embed_dim)
        ...
        # Output heads
        self.vector_field_head = RiemannFMContinuousVFHead(node_dim, manifold)
        self.edge_type_head = RiemannFMDiscreteEdgeHead(edge_dim, num_edge_types)
