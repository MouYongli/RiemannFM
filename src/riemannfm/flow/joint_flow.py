...
class RiemannFMJointFlow(nn.Module):
    ...
    def __init__(
        ...
        """
        super().__init__()
        self.continuous_flow = RiemannFMContinuousFlow(manifold)
        self.discrete_flow = RiemannFMDiscreteFlow(num_edge_types)
        self.node_noise = RiemannFMManifoldNoise(manifold)
        self.edge_noise = RiemannFMSparseEdgeNoise(
