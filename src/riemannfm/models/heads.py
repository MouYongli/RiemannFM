...
RiemannFMContinuousVFHead: predicts tangent vectors on the product manifold.
RiemannFMDiscreteEdgeHead: predicts edge type probabilities.
"""
...
class RiemannFMContinuousVFHead(nn.Module):
    ...
    def __init__(self, hidden_dim: int, manifold: RiemannFMProductManifold):
        super().__init__()
...
class RiemannFMDiscreteEdgeHead(nn.Module):
...
class RiemannFMCardinalityHead(nn.Module):
