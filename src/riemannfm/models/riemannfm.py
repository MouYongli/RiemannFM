"""Top-level RiemannFM model: wraps RED-Former with flow matching.
...
class RiemannFM(nn.Module):
    ...
    - RiemannFMProductManifold for geometry
    - RiemannFMJointFlow for noise/interpolation/sampling
    - RiemannFMRieFormer as the denoising backbone
    ...
    def __init__(
        ...
        # Flow matching
        self.flow_matcher = RiemannFMJointFlow(
            manifold=manifold,
